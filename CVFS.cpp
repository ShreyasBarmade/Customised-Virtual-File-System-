...
PINODE head = NULL;
 ...
 void DisplayHelp()
 {
    ...
    printf("write : To contect into the file\n");
    printf("exit : To Terminate the File System\n");
    printf("stat :  Display information of file using file name\n");
...
int main()
{
    ...
    while (1)
    {
        ...
        if (count == 1)
        {
            ...
            {
                printf("Terminating the Shreyas Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if (count == 3)
        {
            ...
            else if (count == 4)
            {
                if (strcmp(command[0],"lseek") == 0)
                {
                    ...
                    if (fd == -1)
                    {
                        printf("Eroor : Incorrect Parmeter\n");
                        continue;
                    }
                    ret = LseekFile(fd,atoi(command[2]),atoi(command[3]));
                    if (ret == -1)
                    {
                        printf("\nERROR : Unable to perfom lSeek\n");
                    }
